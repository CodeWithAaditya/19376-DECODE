...
public class BlueSideAuto extends LinearOpMode {
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.MM,600, -900,AngleUnit.DEGREES,140);
    ...
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM,600, -900,AngleUnit.DEGREES,140);
