...
@Autonomous(name = "BlueFar9", group = "comp")
        ...
        public Paths(Follower follower) {
            ...
            hpZone = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(56.000, 45.000),
                                    new Pose(34.000, 9.000),
                                    new Pose(24.000, 10.000),
