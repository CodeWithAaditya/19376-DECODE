...
@Autonomous(name = "Blue18BallPartner", group = "comp")
public class Blue18BallPartner extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            spike1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(54.000, 88.000),
                                    new Pose(61.000, 62.000),
                                    new Pose(49.000, 67.000),
    ...
    public static final double GATE_DELAY = 1.5;
